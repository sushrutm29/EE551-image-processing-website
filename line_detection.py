...
#   valid model
def RANSAC(original_img, hessian_img, threshold = 5, plotFig = False, bestInlierRatio = 0.065):
...
def main():
    ...
    RANSAC(uploadImg, hessian_img, 10, False, 0.065)
